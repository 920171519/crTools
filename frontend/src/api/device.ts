...
export const deviceApi = {
  ...
  updateDeviceConfig: (
    deviceId: number,
    configId: number,
    data: DeviceConfigUpdateRequest
  ) => {
  ...
  decideShareRequest: (requestId: number, data: DeviceShareDecisionPayload) => {
    return api.post<DeviceShareRequestItem>(
      `/devices/share-requests/${requestId}/decision`,
      data
    );
  },
  ...
  cancelShareRequest: (requestId: number) => {
    return api.post<DeviceShareRequestItem>(
      `/devices/share-requests/${requestId}/cancel`
    );
  },
  ...
  revokeSharedUser: (requestId: number) => {
    return api.post<DeviceShareRequestItem>(
      `/devices/share-requests/${requestId}/revoke`
    );
  },
